            ...
            <div class="container relative pt-6 sm:pt-10 pb-16 lg:pt-20 lg:pb-28">
                <div class="p-5  bg-white rounded-xl sm:rounded-3xl lg:rounded-[40px] shadow-lg sm:p-10 lg:p-16  mx-4 md:mx-16 sm:mx-8">
                    <header class="text-center max-w-2xl mx-auto - mb-14 sm:mb-16 lg:mb-28 ">
                        <h2 class="flex items-center text-3xl leading-[115%] md:text-5xl md:leading-[115%] font-semibold text-neutral-900  justify-center">Contact us</h2>
                        <span class="block text-sm mt-2 text-neutral-700 sm:text-base ">Drop us message and we will get back for you.</span>
                    </header>
                    <div class="grid gap-8 lg:grid-cols-2">
                        <div class="max-w-sm space-y-6"><div>
                            <h3 class="uppercase font-semibold text-sm  tracking-wider">🗺 ADDRESS</h3>
                            <span class="block mt-2 text-neutral-500 ">Photo booth tattooed prism, portland taiyaki hoodie neutra typewriter</span>
                        </div>
                            <div>
                                <h3 class="uppercase font-semibold text-sm  tracking-wider">💌 EMAIL</h3>
                                <span class="block mt-2 text-neutral-500 ">nc.example@example.com</span>
                            </div>
                            <div>
                                <h3 class="uppercase font-semibold text-sm ">☎ PHONE</h3>
                                <span class="block mt-2 text-neutral-500 ">000-123-456-7890</span>
                            </div>
                            <div>
                                <h3 class="uppercase font-semibold text-sm  tracking-wider">🌏 SOCIALS</h3>
                                <nav class="nc-SocialsList flex space-x-3 text-2xl text-neutral-6000  mt-2"><a class="block" href="#" target="_blank" rel="noopener noreferrer" title="Facebook">
                                    <div>
                                    ...
                                    </div></a><a class="block" href="#" target="_blank" rel="noopener noreferrer" title="Twitter">
                                        <div>
                                            <svg class="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a class="block" href="#" target="_blank" rel="noopener noreferrer" title="Linkedin">
                                        <div>
                                            <svg class="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a class="block" href="#" target="_blank" rel="noopener noreferrer" title="Instagram">
                                        <div>
                                            <svg class="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="border border-neutral-100  lg:hidden">
                        </div>
                        <div>
